(function () {
  ...
  var svcCats  = document.querySelector('.svc-cats');
  var headline = svcCats && svcCats.querySelector('h1');
  ...
  function buildAndAnimate(pFont, sFont) {
    ...
    var r1  = glyphPaths(pFont, 'Ways we bring your', PAD, B1);
    var r2a = glyphPaths(pFont, 'brand to ',          PAD, B2);
    var r2b = glyphPaths(sFont, 'life.',              r2a.endX, B2);

    var W = Math.max(r1.endX, r2b.endX) + PAD;

    var NS  = 'http://www.w3.org/2000/svg';
    var svg = document.createElementNS(NS, 'svg');
    svg.id  = 'svc-headline-svg';
    svg.setAttribute('class',       'svc-svg-headline');
